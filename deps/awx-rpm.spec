...
BuildRequires: python%{python3_pkgversion}-opentelemetry-instrumentation = 0.45~b0
BuildRequires: python%{python3_pkgversion}-opentelemetry-instrumentation-logging = 0.45~b0
...
BuildRequires: python%{python3_pkgversion}-opentelemetry-semantic-conventions = 0.45~b0
...
Requires: python%{python3_pkgversion}-opentelemetry-instrumentation = 0.45~b0
Requires: python%{python3_pkgversion}-opentelemetry-instrumentation-logging = 0.45~b0
Requires: python%{python3_pkgversion}-opentelemetry-proto = 1.24.0
Requires: python%{python3_pkgversion}-opentelemetry-sdk = 1.24.0
Requires: python%{python3_pkgversion}-opentelemetry-semantic-conventions = 0.45~b0
