...
%package -n     python%{python3_pkgversion}-django-solo
Summary:        %{summary}

%description -n python%{python3_pkgversion}-django-solo %_description
...
%files -n python%{python3_pkgversion}-django-solo -f %{pyproject_files}
